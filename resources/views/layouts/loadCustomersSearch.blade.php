                    ...
                    <div class="col-md-10 col-sm-10 col-10">
                        ...
                        <p><i class="fas fa-phone"></i> Phone | <b style="font-weight: 900">{{$customer->phone}}</b></p>
                            ...
                            <div class="col-md-2 offset-md-2">
                                <a href="/viewCustomer/{{$customer->id}}"><button type="button" style="border-radius:20px; font-size:small; color:white" class="btn btn peach-gradient"><b>Прегледај</b></button></a>
                            </div>
                        </div>
