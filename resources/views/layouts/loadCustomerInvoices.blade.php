<div id="load">
                    ...
                    <div class="col-md-10 col-sm-10 col-10">
                        ...
                        <p><i class="fas fa-chart-line"></i> Amount | <b style="font-weight: 900">€{{number_format($total)}} EUR</b></p>
                            ...
                            <div class="col-md-2 offset-md-2">
                                <a href="{{ route('login') }}"><button type="button" style="border-radius:20px; font-size:small; color:white" class="btn purple-gradient"><b>View</b></button></a>
    ...
    <div class="text-right">
        <span style="color:#808080; font-style:italic;font-family: 'Ubuntu', sans-serif; font-weight:900">Showing {{ $invoices->firstItem() }} to {{ $invoices->lastItem() }} from total {{$invoices->total()}} invoices</span>
        </div>
