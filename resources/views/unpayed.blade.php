...
<div class="container">
    <div id="heading" class="row text-center">
        <div class="col-md-12">
            <h1 style="font-size: 3.5em; margin-bottom:3%;font-family: 'Ubuntu', sans-serif !important;"><b>Showing All Unpaid Invoices</b></h1>
            <hr>
        ...
        <div class="col-md-4 col-sm-12 col-12">
            <div class="row">
                ...
                <div class="col-md-10 col-sm-12 col-12" style="background-color: rgba(0, 0, 0, 0.01); margin-top:6.5%;box-shadow: 0px 0px 15px -5px rgba(1, 2, 1, 0.3);border: 1px solid #E8E8E8; color:#505050;border-radius:10px; padding-top:10%; padding-bottom:5%">
                    <h5 style="font-size: 1.6em;font-family: 'Ubuntu', sans-serif;" class="boldFilter text-center tools"> <i style="font-size:3em;"class="fas fa-business-time"></i></h5>
                    <hr>
                    <div class="row tools">
                        <div class="col-md-12">
        ...
        <div class="col-md-8" style="margin-top: 2.6%; background-color: rgba(0, 0, 0, 0.01);box-shadow: 0px 0px 15px -5px rgba(1, 2, 1, 0.3);border: 1px solid #E8E8E8; color:#505050;border-radius:10px; padding-top:3%; padding-bottom:5%">
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-12 text-center">
                        <h5 style="font-size: 1.6em;font-family: 'Ubuntu', sans-serif;" class="boldFilter text-center tools"><i style="font-size: 3em;" class="fas fa-money-check-alt"></i> </h5>
                        <hr>
                    </div>
                    <div class="row">
                    <div class="col-md-12 col-sm-12 col-12">
                        <div class="form-group has-search">
                            <input id="searchInvoiceUnpayed" type="text" class="form-control rounded-pill" placeholder='Search invoices by number, date or customer...'>
                        </div>
                        <hr style="width: 60%">
                    </div>
            ...
            <div class="row">
                <div class="col-md-12 tools">
                    @if (count($invoices) > 0)
                        <section class="productsUn">
                            @include('layouts.loadUnpayed')
                        </section>
                    @endif
...
<script type="text/javascript">
   ...
   $(function() {
        ...
        $(document).on('keyup','#searchInvoiceUnpayed',function(){
            $('.productsUn').html('');
        $value=$(this).val();
        $.ajax({
        type : 'get',
        url : '{{URL::to('searchInvoiceUnpayed')}}',
        data:{'search':$value},
        success:function(data){
        $('.productsUn').hide().html(data).fadeIn(1500);
        }
        });
    });
