...
<div class="container">
    <div id="heading" class="row text-center">
        <div class="col-md-12">
        <h1 style="font-size: 3.5em; margin-bottom:3%;font-family: 'Ubuntu', sans-serif !important;"><b>Create new invoice for {{$customer->name}}</b></h1>
            <hr>
                ...
                <div class="col-md-10 col-sm-12 col-12" style="background-color: rgba(0, 0, 0, 0.01); margin-top:6.5%;box-shadow: 0px 0px 15px -5px rgba(1, 2, 1, 0.3);border: 1px solid #E8E8E8; color:#505050;border-radius:10px; padding-top:10%; padding-bottom:5%">
                    ...
                    <div class="row tools">
                        <div class="col-md-12 text-center">
                            <a href="/viewCustomer/{{$customer->id}}"><button type="button" style="border-radius:50px; font-size:larger; padding-left:5%; padding-right:5%; color:white" class="btn peach-gradient"><i class="fas fa-backward"></i> Назад</button></a>
                        </div>
                    </div>
                    <hr>
                    <div class="row tools">
                        <div class="col-md-12 text-center">
                            <h5 style="font-weight: bold">Finantial Statement</h5>
                        </div>
                    </div>
                    <hr>
                    <div class="row tools">
                    ...
                    <div class="row tools">
                        <div class="col-md-12 text-center">
                            <p class="cloudy-knoxville-gradient" style="font-size: larger;  border-radius:50px;box-shadow: 0px 0px 15px -3px rgba(1, 2, 1, 0.3);"> Paid Amount  <br><b style="font-weight: 900; font-size: xx-large;">€{{number_format($total)}}</b> EUR</p>
                        </div>
                    </div>
                    @php
                            $totalUn = 0;
                    ...
                    <div class="row tools">
                        <div class="col-md-12 text-center">
                            <p  class="cloudy-knoxville-gradient" style="font-size: larger;  border-radius:50px;box-shadow: 0px 0px 15px -3px rgba(1, 2, 1, 0.3);">  Unpaid Amount   <br><b style="font-weight: 900; font-size: xx-large; color:red">€{{number_format($totalUn)}}</b> EUR</p>
                        </div>
                    </div>
        ...
        <div class="col-md-8" style="margin-top: 2.6%; background-color: rgba(0, 0, 0, 0.01); box-shadow: 0px 0px 15px -5px rgba(1, 2, 1, 0.3);border: 1px solid #E8E8E8; color:#505050;border-radius:10px; padding-top:3%; padding-bottom:5%">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-12 tools text-center" style="margin-top: 8%;">
                    <h5><i class="fas fa-user"></i> | <b>{{$customer->name}} </b></h5>
                    <hr style="width: 50%">
                    </div>
                <div class="col-md-12" style="margin-top: 5%">
                <form method="POST" action="/addInvoiceToCustomer/{{$customer->id}}">
                        @csrf
